...
-- INTERFACE
-----------------------------------------------------------------------------
mkstr(SI.TELECLOSE, "Fechar")
mkstr(SI.TELE_UI_PLAYER, "Jogador")
...
---------
--------- Buttons
mkstr(SI.TELE_UI_BTN_SEARCH_PLAYER, "Procurar por jogador")
mkstr(SI.TELE_UI_BTN_SEARCH_ZONE, "Procurar por Zona")
...
mkstr(SI.TELE_UI_BTN_CURRENT_ZONE, "A única zona exibida")
mkstr(SI.TELE_UI_BTN_CURRENT_ZONE_DELVES, "Covís (na zona exibida)")
mkstr(SI.TELE_UI_BTN_SETTINGS, "Configuração")
mkstr(SI.TELE_UI_BTN_FEEDBACK, "Comentários")
...
mkstr(SI.TELE_UI_BTN_RELATED_QUESTS, "Ativar Missões")
...
---------
--------- List
mkstr(SI.TELE_UI_SOURCE_GROUP, "Grupo")
mkstr(SI.TELE_UI_SOURCE_FRIEND, "Amigos")
mkstr(SI.TELE_UI_NO_MATCHES, "Sem combinações")
...
mkstr(SI.TELE_UI_DISCOVERED_WAYSHRINES, "Santuários Descobertos:")
mkstr(SI.TELE_UI_DISCOVERED_SKYSHARDS, "Fragmentos Celestes Coletados:")
---------
--------- Menu
...
mkstr(SI.TELE_UI_ADD_TO_GROUP, "Convidar para Grupo")
mkstr(SI.TELE_UI_PROMOTE_TO_LEADER, "Promover para Lider")
mkstr(SI.TELE_UI_VOTE_TO_LEADER, "Votar o Lider")
mkstr(SI.TELE_UI_KICK_FROM_GROUP, "Retirar do Grupo")
mkstr(SI.TELE_UI_VOTE_KICK_FROM_GROUP, "Votar para Retirar")
mkstr(SI.TELE_UI_LEAVE_GROUP, "Sair do Grupo")
mkstr(SI.TELE_UI_WHISPER_PLAYER, "Sussurar")
mkstr(SI.TELE_UI_JUMP_TO_HOUSE, "Visitar Residência Primária")
mkstr(SI.TELE_UI_ADD_FRIEND, "Adicionar Amigo")
mkstr(SI.TELE_UI_REMOVE_FRIEND, "Remover Amigo")
mkstr(SI.TELE_UI_SEND_MAIL, "Enviar Email")
mkstr(SI.TELE_UI_FILTER_GROUP, "Apenas Grupo")
mkstr(SI.TELE_UI_FILTER_FRIENDS, "Apenas Amigos")
mkstr(SI.TELE_UI_FILTER_GUILDS, "somente guildas")
...
mkstr(SI.TELE_UI_SET_PRIMARY_HOUSE, "Faça residência principal")
mkstr(SI.TELE_UI_TOGGLE_HOUSE_NICKNAME, "Mostre apelidos")
mkstr(SI.TELE_UI_VIEW_MAP_ITEM, "Exibir item do mapa")
mkstr(SI.TELE_UI_BANK, "Banco:")
mkstr(SI.TELE_UI_LEAD, "Lead:")
mkstr(SI.TELE_UI_TOGGLE_SURVEY_MAP, "Mapas de Pesquisa")
mkstr(SI.TELE_UI_TOGGLE_TREASURE_MAP, "Mapas de Tesouro")
mkstr(SI.TELE_UI_TOGGLE_LEADS_MAP, "Leads")
mkstr(SI.TELE_UI_VIEW_ANTIQUITY, "Visualizar Codex")
mkstr(SI.TELE_UI_JUMP_IN_FRONT_HOUSE, "Viajar para fora da casa")
mkstr(SI.TELE_UI_JUMP_IN_HOUSE, "Viajar para dentro da casa")
...
mkstr(SI.TELE_UI_TOGGLE_ALL_DELVES, "Mostre tudo")
mkstr(SI.TELE_UI_DAYS_LEFT, "%d dias restantes")
mkstr(SI.TELE_UI_TOGGLE_INCLUDE_BANK_MAP, "Incluir banco")
mkstr(SI.TELE_UI_TOGGLE_DLC_NAMES, "Mostrar nomes de DLC")

mkstr(SI.TELE_UI_SUBMENU_FAVORITES, "Favoritos")
mkstr(SI.TELE_UI_SUBMENU_MISC, "Diversos")
mkstr(SI.TELE_UI_SUBMENU_GROUP, "Grupo")
...
-- CHAT OUTPUTS
-----------------------------------------------------------------------------
mkstr(SI.TELE_CHAT_ERROR_WHILE_PORTING, "Incapaz de viajar para o jogador")
mkstr(SI.TELE_CHAT_TO_PLAYER, "Viajando para Jogador:")
mkstr(SI.TELE_CHAT_UNLOCK_START_INFO, "Iniciar auto desbloqueio ...")
mkstr(SI.TELE_CHAT_ERROR, "Erro ao viajar para o jogador")
mkstr(SI.TELE_CHAT_UNLOCK_WS_SUCCESS, "Desbloqueio automático bem sucedido")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_CALC, "Calculando Santuários desbloqueados ...")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_PLU, "Novos Santuários foram desbloqueados")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_SING, "Novo Santuário foi desbloqueado")
mkstr(SI.TELE_CHAT_UNLOCK_WS_NO_PLAYERS, "Sem jogadores para viajar")
...
mkstr(SI.TELE_CHAT_FAVORITE_ZONE_NO_FAST_TRAVEL, "Não é encontrada uma opção de viagem rápida")
mkstr(SI.TELE_CHAT_NOT_IN_GROUP, "Você não está em um grupo")
mkstr(SI.TELE_CHAT_PORTING_NOT_POSSIBLE, "Viagem rápida não é possível no momento")
mkstr(SI.TELE_CHAT_PORT_TO_OWN_HOUSE, "Viajar para a própria residência:")
...
mkstr(SI.TELE_CHAT_UNLOCK_WS_ALL_KNOWN, "Todos os Santuários nesta zona são conhecidas e podem ser usados para viajar.")
...
mkstr(SI.TELE_CHAT_TO_DUNGEON, "Viagem rápida para a instância:")
mkstr(SI.TELE_CHAT_TO_TRACKED_QUEST, "Alternando para missão selecionada:")
...
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG, "Ocultar o diálogo de confirmação de desbloqueio automático")
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG_TOOLTIP, "Não mostre qualquer caixa de diálogo de confirmação quando você usa o recurso de desbloqueio automático.")
...
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES, "Mostre apelidos de casas")
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES_TOOLTIP, "Exibe os apelidos (mutáveis) de suas casas em vez dos nomes regulares.")
...
mkstr(SI.TELE_SETTINGS_INFO_CHARACTER_DEPENDING, "|ca20000Esta opção está vinculada ao seu personagem (não há conta)!|r")
...
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_CURRENT_ZONE, "Zona atual")
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_DELVES, "Covis na zona atual")
...
mkstr(SI.TELE_KEYBINDING_GROUP_LEADER, "Viajar para Líder do Grupo")
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_ACTIVE_QUESTS, "Missões ativas")
mkstr(SI.TELE_KEYBINDING_PRIMARY_RESIDENCE, "Viajar em residência primária")
mkstr(SI.TELE_KEYBINDING_GUILD_HOUSE_BMU, "Visite BeamMeUp Guild House")
...
mkstr(SI.TELE_DIALOG_AUTO_UNLOCK_BODY, "Ao confirmar, o BeamMeUp inicia uma série de operações de viagem rápidas incompletas para os jogadores na sua zona atual. Se esses jogadores estiverem na vizinhança de Santuários Desconhecidos, esse processo é suficiente para você ser capaz de usar essas manifestações no futuro. Observe que o Guia da Zona / Conclusão do Mapa não será atualizado até que você visite fisicamente os Santuários.")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE, "Desbloquear não é mais necessário")
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY, "Todas os Santuários na zona atual já foram desbloqueadas.")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE2, "Desbloquear não é possível")
