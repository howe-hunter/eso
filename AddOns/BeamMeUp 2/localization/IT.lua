...
-- INTERFACE
-----------------------------------------------------------------------------
mkstr(SI.TELECLOSE, "Chiudi")
mkstr(SI.TELE_UI_PLAYER, "Giocatore")
mkstr(SI.TELE_UI_ZONE, "Zona")
...
---------
--------- Buttons
mkstr(SI.TELE_UI_BTN_SEARCH_PLAYER, "Ricerca per Giocatore")
mkstr(SI.TELE_UI_BTN_SEARCH_ZONE, "Ricerca per Zona")
...
mkstr(SI.TELE_UI_BTN_CURRENT_ZONE, "Solo Zona Visualizzata")
mkstr(SI.TELE_UI_BTN_CURRENT_ZONE_DELVES, "Visualizza Delve (nella Zona)")
mkstr(SI.TELE_UI_BTN_SETTINGS, "Settaggi")
...
mkstr(SI.TELE_UI_BTN_RELATED_QUESTS, "Missioni Attive")
...
---------
--------- List
mkstr(SI.TELE_UI_SOURCE_GROUP, "Gruppo")
mkstr(SI.TELE_UI_SOURCE_FRIEND, "Amici")
mkstr(SI.TELE_UI_NO_MATCHES, "Nessun Risultato")
...
mkstr(SI.TELE_UI_DISCOVERED_WAYSHRINES, "Santuari Scoperti:")
mkstr(SI.TELE_UI_DISCOVERED_SKYSHARDS, "Frammenti Celesti raccolti:")
---------
--------- Menu
...
mkstr(SI.TELE_UI_ADD_TO_GROUP, "Invita in Gruppo")
mkstr(SI.TELE_UI_PROMOTE_TO_LEADER, "Promuovi a Capo Gruppo")
mkstr(SI.TELE_UI_VOTE_TO_LEADER, "Vota a Capo Gruppo")
mkstr(SI.TELE_UI_KICK_FROM_GROUP, "Espelli dal Gruppo")
mkstr(SI.TELE_UI_VOTE_KICK_FROM_GROUP, "Vota per Espellere")
mkstr(SI.TELE_UI_LEAVE_GROUP, "Lascia Gruppo")
mkstr(SI.TELE_UI_WHISPER_PLAYER, "Messaggio Privato")
mkstr(SI.TELE_UI_JUMP_TO_HOUSE, "Visita la Residenza Primaria")
mkstr(SI.TELE_UI_ADD_FRIEND, "Aggiungi Amico")
mkstr(SI.TELE_UI_REMOVE_FRIEND, "Rimuovi Amico")
mkstr(SI.TELE_UI_SEND_MAIL, "Manda Email")
mkstr(SI.TELE_UI_FILTER_GROUP, "Solo Gruppi")
mkstr(SI.TELE_UI_FILTER_FRIENDS, "Solo Amici")
mkstr(SI.TELE_UI_FILTER_GUILDS, "Solo Gilde")
...
mkstr(SI.TELE_UI_SET_PRIMARY_HOUSE, "Segna come Residenza Primaria")
mkstr(SI.TELE_UI_TOGGLE_HOUSE_NICKNAME, "Mostra Sopranomi")
mkstr(SI.TELE_UI_VIEW_MAP_ITEM, "Visualizza Mappa Oggetti")
mkstr(SI.TELE_UI_BANK, "Banca:")
mkstr(SI.TELE_UI_LEAD, "Indizzi:")
mkstr(SI.TELE_UI_TOGGLE_SURVEY_MAP, "Mappe di Ricerca")
mkstr(SI.TELE_UI_TOGGLE_TREASURE_MAP, "Mappe del Tesoro")
mkstr(SI.TELE_UI_TOGGLE_LEADS_MAP, "Indizzi")
mkstr(SI.TELE_UI_VIEW_ANTIQUITY, "Visualizza Codex")
mkstr(SI.TELE_UI_JUMP_IN_FRONT_HOUSE, "Viaggia fuori la Casa")
mkstr(SI.TELE_UI_JUMP_IN_HOUSE, "Viaggia dentro la Casa")
...
mkstr(SI.TELE_UI_SUBMENU_MISC, "Varie")
mkstr(SI.TELE_UI_SUBMENU_GROUP, "Gruppo")
mkstr(SI.TELE_UI_SUBMENU_FILTER, "Filtro")
...
-- CHAT OUTPUTS
-----------------------------------------------------------------------------
mkstr(SI.TELE_CHAT_ERROR_WHILE_PORTING, "Impossibile viaggiare verso il Giocatore")
mkstr(SI.TELE_CHAT_TO_PLAYER, "In Viaggio Verso il Giocatore:")
mkstr(SI.TELE_CHAT_UNLOCK_START_INFO, "Avvia Sblocco Automatico ...")
mkstr(SI.TELE_CHAT_ERROR, "Errore durante il viaggio verso il Giocatore")
mkstr(SI.TELE_CHAT_UNLOCK_WS_SUCCESS, "Sblocco Automatico completato con successo")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_CALC, "Calcolo Santuari sbloccati ...")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_PLU, "nuovi santuari sono stati sbloccati")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_SING, "nuovo wayshrine è stato sbloccato")
mkstr(SI.TELE_CHAT_UNLOCK_WS_NO_PLAYERS, "Nessun Giocatore dove Viaggiare")
...
mkstr(SI.TELE_CHAT_FAVORITE_ZONE_NO_FAST_TRAVEL, "Nessuna opzione di viaggio veloce trovata")
mkstr(SI.TELE_CHAT_NOT_IN_GROUP, "Non sei in un gruppo")
mkstr(SI.TELE_CHAT_PORTING_NOT_POSSIBLE, "Viaggio veloce non disponibile al momento")
mkstr(SI.TELE_CHAT_PORT_TO_OWN_HOUSE, "In Viaggio verso la propria Residenza:")
...
mkstr(SI.TELE_CHAT_UNLOCK_WS_ALL_KNOWN, "Tutti i santuari in questa zona sono conosciuti e possono essere usati per viaggiare.")
...
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG, "Nascondi la finestra di conferma di sblocco automatico")
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG_TOOLTIP, "Non mostrare alcuna finestra di conferma quando si utilizza la funzione di sblocco automatico.")
...
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES, "Mostra soprannomi delle case")
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES_TOOLTIP, "Mostra i soprannomi (cambiabili) delle tue case invece dei nomi regolari.")
...
mkstr(SI.TELE_SETTINGS_INFO_CHARACTER_DEPENDING, "|ca20000Questa opzione è collegata al tuo personaggio (non a livello di account)!|r")
...
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_CURRENT_ZONE, "Zona attuale")
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_DELVES, "Miniere nella zona corrente")
...
mkstr(SI.TELE_KEYBINDING_GROUP_LEADER, "Viaggi dal capogruppo")
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_ACTIVE_QUESTS, "Missioni Attive")
...
mkstr(SI.TELE_DIALOG_AUTO_UNLOCK_BODY, "Confermando, Beammeup inizia una serie di operazioni di viaggio rapide incomplete per i giocatori nella tua zona corrente. Se questi giocatori sono nelle vicinanze di santuari sconosciuti, questo processo è sufficiente per essere in grado di utilizzare questi santuari in futuro. Nota che il completamento della Guida Zona/mappa non sarà aggiornato fino a quando non visiterai fisicamente i santuari.")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE, "Lo sblocco non è più necessario")
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY, "Tutti i santuari della zona attuale sono già stati sbloccati.")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE2, "Lo sblocco non è possibile")
