...
-- INTERFACE
-----------------------------------------------------------------------------
mkstr(SI.TELECLOSE, "Zamknij")
mkstr(SI.TELE_UI_PLAYER, "Gracz")
mkstr(SI.TELE_UI_ZONE, "Strefa")
...
---------
--------- Buttons
mkstr(SI.TELE_UI_BTN_SEARCH_PLAYER, "Wyszukaj po graczu")
mkstr(SI.TELE_UI_BTN_SEARCH_ZONE, "Wyszukaj po strefie")
...
mkstr(SI.TELE_UI_BTN_RELATED_QUESTS, "Aktywne zadania")
...
mkstr(SI.TELE_UI_SOURCE_FRIEND, "Przyjaciel")
mkstr(SI.TELE_UI_NO_MATCHES, "Brak wyników")
...
mkstr(SI.TELE_UI_DISCOVERED_WAYSHRINES, "Odkryte kapliczki:")
mkstr(SI.TELE_UI_DISCOVERED_SKYSHARDS, "Odkryte niebiańskie odłamki:")
---------
--------- Menu
...
mkstr(SI.TELE_UI_ADD_TO_GROUP, "Zaproś do grupy")
mkstr(SI.TELE_UI_PROMOTE_TO_LEADER, "Awansuj na lidera")
mkstr(SI.TELE_UI_VOTE_TO_LEADER, "Głosowanie na lidera")
mkstr(SI.TELE_UI_KICK_FROM_GROUP, "Usuń z grupy")
mkstr(SI.TELE_UI_VOTE_KICK_FROM_GROUP, "Głosowanie za usunięciem")
mkstr(SI.TELE_UI_LEAVE_GROUP, "Opuść grupę")
mkstr(SI.TELE_UI_WHISPER_PLAYER, "Szepcz")
mkstr(SI.TELE_UI_JUMP_TO_HOUSE, "Odwiedź główną rezydencję")
mkstr(SI.TELE_UI_ADD_FRIEND, "Dodaj przyjaciela")
mkstr(SI.TELE_UI_REMOVE_FRIEND, "Usuń przyjaciela")
mkstr(SI.TELE_UI_SEND_MAIL, "Wyślij wiadomość")
mkstr(SI.TELE_UI_FILTER_GROUP, "Tylko grupa")
mkstr(SI.TELE_UI_FILTER_FRIENDS, "Tylko przyjaciele")
mkstr(SI.TELE_UI_FILTER_GUILDS, "Tylko gildie")
...
mkstr(SI.TELE_UI_SET_PRIMARY_HOUSE, "Ustaw jako główną rezydencję")
...
mkstr(SI.TELE_UI_LEAD, "Wskazówka wizji:")
mkstr(SI.TELE_UI_TOGGLE_SURVEY_MAP, "Mapy badawcze")
mkstr(SI.TELE_UI_TOGGLE_TREASURE_MAP, "Mapy skarbów")
mkstr(SI.TELE_UI_TOGGLE_LEADS_MAP, "Wskazówki wizji")
...
mkstr(SI.TELE_UI_TOGGLE_ALL_DELVES, "Pokaż wszystkie")
mkstr(SI.TELE_UI_DAYS_LEFT, "Pozostało %d dni")
mkstr(SI.TELE_UI_TOGGLE_INCLUDE_BANK_MAP, "Pokaż zawarte w banku")
...
mkstr(SI.TELE_UI_SUBMENU_GROUP, "Grupa")
mkstr(SI.TELE_UI_SUBMENU_FILTER, "Filtr")
...
-- CHAT OUTPUTS
-----------------------------------------------------------------------------
mkstr(SI.TELE_CHAT_ERROR_WHILE_PORTING, "Niemożliwa podróż do gracza")
mkstr(SI.TELE_CHAT_TO_PLAYER, "Podróż do gracza:")
mkstr(SI.TELE_CHAT_UNLOCK_START_INFO, "Zaczynam odblokowywanie ...")
mkstr(SI.TELE_CHAT_ERROR, "Błąd w trakcie podróży do gracza")
mkstr(SI.TELE_CHAT_UNLOCK_WS_SUCCESS, "Automatyczne odblokowanie zakończone sukcesem")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_CALC, "Kalkuluje odblokowane kapliczki ...")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_PLU, "nowe kapliczki zotały odblokowane")
mkstr(SI.TELE_CHAT_UNLOCK_WS_COUNT_SING, "nowa kapliczka został odblokowany")
mkstr(SI.TELE_CHAT_UNLOCK_WS_NO_PLAYERS, "Brak graczy do podróży")
...
mkstr(SI.TELE_CHAT_FAVORITE_ZONE_NO_FAST_TRAVEL, "Nie znaleziono opcji Szybkiej Podróży")
mkstr(SI.TELE_CHAT_NOT_IN_GROUP, "Nie jesteś w grupie")
mkstr(SI.TELE_CHAT_PORTING_NOT_POSSIBLE, "Szybka Podróż jest niemożliwa w tym momencie")
mkstr(SI.TELE_CHAT_PORT_TO_OWN_HOUSE, "Podróż do posiadanej rezydencji:")
...
mkstr(SI.TELE_CHAT_TO_DUNGEON, "Szybka podróż do instancji:")
mkstr(SI.TELE_CHAT_TO_TRACKED_QUEST, "Podróż do śledzonego zadania:")
...
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG, "Ukryj okno dialogowe potwierdzenia Automatycznego Odblokowania")
mkstr(SI.TELE_SETTINGS_DISABLE_DIALOG_TOOLTIP, "Nie pokazuj żadnego okna potwierdzenia kiedy używasz funkcji Automatycznego Odblokowania.")
...
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES, "Pokaż nazwy rezydencji")
mkstr(SI.TELE_SETTINGS_HOUSE_NICKNAMES_TOOLTIP, "Pokazuje nazwy (zmienialne) Twoich rezydencji zamiast zwykłych nazw.")
...
mkstr(SI.TELE_SETTINGS_INFO_CHARACTER_DEPENDING, "|ca20000Ta opcja jest przypięta do postaci (nie całego konta)!|r")
...
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_CURRENT_ZONE, "Obecna strefa")
mkstr(SI.TELE_KEYBINDING_TOGGLE_MAIN_DELVES, "Groty w obecnej strefie")
...
mkstr(SI.TELE_DIALOG_AUTO_UNLOCK_BODY, "Potwierdzając, BeamMeUp rozpocznie serię niepełnych szybkich podróży do graczy bieżącej strefie. Jeśli ci gracze znajdują się w pobliżu nieznanych kapliczek, ten proces jest wystarczający, abyś mógł z nich korzystać w przyszłości. Pamiętaj, że przewodnik po mapie nie zostanie zaktualizowany, dopóki fizycznie nie odwiedzisz kapliczek.")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE, "Odblokowanie nie jest już potrzebne")
...
mkstr(SI.TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE2, "Odblokowanie jest niemożliwe")
