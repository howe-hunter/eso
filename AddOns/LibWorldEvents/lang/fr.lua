...
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_LN_SCAB_RIDGE",  "Crête de croûte") -- South-West

-- Dragon status
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_STATUS_FIGHT",   "En combat")
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_STATUS_KILLED",  "Tué")
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_STATUS_UNKNOWN", "Inconnu")
...
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_DRAGON_COLOR_GREY",  "dragon gris")
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_DRAGON_COLOR_BLACK", "dragon noir")
ZO_CreateStringId("SI_LIB_WORLD_EVENTS_DRAGON_COLOR_WHITE", "dragon blanc")
