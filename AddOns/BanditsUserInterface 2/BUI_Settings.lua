...
MenuActions="/esoui/art/emotes/emotes_indexicon_perpetual_up.dds",
...
--		disabled	=function() return BUI.API>100033 end,
	...
	{	type		="dropdown",
		name		="ReticleMode",
		choices	={"Default","Crosshair","Rhomboid","Circular","Triangle 1","Triangle 2","Dotty","Brackets"},
...
--		type="submenu", name="PlayerHeader", controls={
	...
	{	type		="dropdown",
		name		="PlayerHeader",
		choices	={"Default frames","Default: pyramid","Bandits frames","Bandits: pyramid","Bandits: vertical","Disabled"},
		getFunc	=function()
					...
					elseif BUI.Vars.PlayerFrame then
						if BUI.Vars.FrameHorisontal then
							return BUI.Vars.RepositionFrames and "Bandits: pyramid" or "Bandits frames"
...
--						if not old1 then SCENE_MANAGER:SetInUIMode(false) BUI.OnScreen.Notification(8,"Reloading UI") BUI.CallLater("ReloadUI",1000,ReloadUI) end
					elseif value=="Bandits frames" then
...
function BUI.Menu.Reset(context)
	...
	elseif context=="Positions" then
		if MoveMode_1 then
			local frames={"BUI_OnScreen","BUI_PlayerFrame","BUI_HPlayerFrame","BUI_TargetFrame","BUI_BossFrame","BUI_RaidFrame","BUI_MiniMeter","BUI_BuffsP","BUI_BuffsPas","BUI_BuffsT","BUI_BuffsC"}
