...
local DailyPledges={
	...
	[3]={	--Urgarlag
		...
		{en="Red Petal Bastion",	ru="Олот Алый Лепесток",	de="RotblГјtenbastion",		fr="Bastion du Pétale rouge"},
...
local function ChangeLabel(Type)
	local name=Type==ITEMTYPE_FISH and "UI_SHORTCUT_TERTIARY" or "UI_SHORTCUT_SECONDARY"
