...
local RapidManeuver,AdditionalCastTime,AbilityEffect,AbilityName,QueueAbility={},{},{},{},nil
local theme_color
...
--	d(BUI.TimeStamp().."["..abilityId.."] |t16:16:"..iconName.."|t "..effectName.."|| "..unitTag.."|| duration: "..math.floor((endTimeSec-startTimeSec)*100)/100 .."|| "..EffectResults[changeType])	--.."|| "..EffectResults[changeType].."|| "..BuffTypes[buffType].."|| "..BuffEffectTypes[effectType]..", AbType:  "..AbilityTypes[abilityType].."|| "..", StatusEff: "..StatusEffectTypes[statusEffectType]
	if QueueAbility then
		local duration=math.floor((endTimeSec-startTimeSec)*1000)
--		d("["..abilityId.."("..QueueAbility.id..")] |cE0E0E0"..effectName.."|r start: "..math.floor(QueueAbility.start/100)/10 .."="..math.floor(startTimeSec*10)/10 .." duration: "..duration.."("..BUI.Actions.AbilityBar[QueueAbility.id].DurationBase..")")
		if QueueAbility.id==abilityId or QueueAbility.id==AbilityEffect[abilityId] then
			StartTimer(QueueAbility.id,duration,stackCount,effectType)
		elseif QueueAbility.id==AbilityName[effectName] then
			AbilityEffect[abilityId]=QueueAbility.id
			StartTimer(QueueAbility.id,duration,stackCount,effectType)
