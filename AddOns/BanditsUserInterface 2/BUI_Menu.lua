...
local function SettingsWindow_Init()
	...
	ui.info	=BUI.UI.Label("$(parent)_info", ui, {645,14}, {TOPRIGHT,TOPLEFT,-10,0,ui.website}, Loc["PANEL_INFO_FONT"], nil, {2,0}, zo_strformat(Loc["AUTHOR"], Loc["CREATOR"]).."  "..zo_strformat(Loc["VERSION"], ver))
	--Dialogs
