		...
		if gExperienceData then
			...
			if AUI.Settings.Combat.scrolling_text_show_cxp then
				...
				if cxp > 0 then
					...
					local pointType = 0
					if apiVersion >= 100034 then
						pointType = GetChampionPointPoolForRank(GetPlayerChampionPointsEarned() + 1)
					else
						pointType = GetChampionPointAttributeForRank(GetPlayerChampionPointsEarned() + 1)
					end
