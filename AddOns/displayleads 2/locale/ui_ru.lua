...
RDL.DropdownData = {
	ChoicesMajor  = { "Можно найти", "Можно выкопать", "Не все записи кодекса", "Ни разу не выкопанные", "Активные ", "Все", "Групповые подземелья", "Deadlands",},
	...
	TooltipsMajor  = {
		...
		"Показать только новые зацепки из дополнения 'Deadlands'",
	},
	
	ChoicesZone = {RDL.ZONENAME_ALLZONES, "Текущая зона", "Исключить второстепенные DLC", },
	TooltipsZone = { 
