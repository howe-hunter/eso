...
RDL.DropdownData = {
	ChoicesMajor  = { "Vous pouvez trouver", "Vous pouvez localiser", "Entrées Codex manquantes", "Jamais creusé", "Pistes exploitables", "Toutes les pistes", "Donjons de groupe", "Deadlands",},
