...
function class:ZoneChange(trackedZoneId, enterHandler, exitHandler)
    return libHandlerZoneChange:New(self, trackedZoneId, enterHandler, exitHandler)
end

function class:MapChange(trackedMapId, enterHandler, exitHandler)
    return libHandlerMapChange:New(self, trackedMapId, enterHandler, exitHandler)
end
